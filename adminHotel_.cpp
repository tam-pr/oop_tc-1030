...
void Hotel::sethotelName(){
    cout <<"Enter hotel name: " <<endl;
    cin >> hotelName; 
        }

void Hotel::settotalRooms(){
    cout <<"Enter total number of rooms: " <<endl;
    cin >> totalRooms; 

        }
    
void Hotel::setroomNumbers(){
...
int Room::getnumberAdults(){
    cout <<"Enter number of adults: " <<endl;
    cin >> numberAdults; 
    return numberAdults; 
        }

int Room::getnumberChildren(){
    cout <<"Enter number of children: " <<endl;
    cin >> numberChildren; 
    return numberChildren; 
        }

int Room::getstartingTariff(){
    getnumberAdults();
    getnumberChildren();
